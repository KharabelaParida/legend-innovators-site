...
const offers = [
  {
    ...
    points: [
      "Private Limited, One Person Company (OPC), Public Limited",
      "LLP, Section 8/NGO, Producer Company, Partnership, Sole Proprietorship, Trust",
    ],
  },
  {
    title: "Intellectual Property Protection",
    points: [
      "Trademark registration (for startups, MSMEs, and large enterprises)",
      "Copyright registration (logos, content, videos, films)",
      "Patent registration (device and medical patents)",
    ],
  },
  {
    title: "Startup Support",
    points: [
      "Startup India registration and grant assistance",
    ],
  },
  {
    title: "Business Communication & Brand Development",
    points: [
      "Contract drafting and legal documentation",
      "Core content creation (vision, mission, USPs)",
      "Pitch deck and presentation development",
      "Logo design, brand anthem, and creative conceptualization",
    ],
  },
];
...
const whoFor = [
  "New entrepreneurs",
  "Aspiring founders",
  "Teams forming startups or NGOs",
  "Existing businesses expanding or re-structuring",
];

const benefits = [
  "Fast, error-free, and fully compliant setup",
  "Strong legal and brand foundation from the beginning",
  "Protection of your ideas and intellectual assets",
  "Professional materials that impress investors and customers",
];

const process = [
  "Consultation & Requirement Mapping",
  "Documentation & Filing",
  "Approval & Registration",
  "Brand & Communication Development",
  "Handover & Post-Setup Support",
];
    ...
    <main className="sp-page">
      ...
      <section className="sp-hero">
        ...
        <div className="sp-container">
          ...
          <p className="sp-eyebrow">Business Establishment</p>
          <h1 className="sp-hero-title">
            Launch Your Business Legally, Professionally,{" "}
            <span className="sp-gold">and with Confidence</span>
          </h1>
          <p className="sp-hero-desc">
            End-to-end support for company registration, intellectual property protection, startup recognition, and brand development – so you can focus on growth from day one.
          </p>
      ...
      <section className="sp-section sp-white">
        <div className="sp-container">
          <p className="sp-section-tag">What We Provide</p>
          <h2 className="sp-section-title">Complete Business Setup Support</h2>
          <p className="sp-section-desc">
            Everything you need to launch your business legally, professionally, and confidently — all under one roof.
          </p>
      ...
      <section className="sp-section sp-gray" id="process">
        <div className="sp-container">
          ...
          <h2 className="sp-section-title">Our Simple Process</h2>
        ...
        <div className="sp-container">
          <div className="sp-cta-box">
            ...
            <div className="sp-cta-content">
              <h2 className="sp-cta-title">Start Your Business Journey Right</h2>
              <p className="sp-cta-desc">
                Avoid costly mistakes and delays. Book a free consultation today and launch your venture with a solid, professional foundation.
              </p>
              <div className="sp-cta-buttons">
                ...
                <Link href="/dashboard" className="sp-cta-btn-secondary">
                  Purchase Business Setup Package
                </Link>
              </div>
            </div>
          </div>
