...
const offers = [
  {
    title: "Strategic Funding Planning",
    points: [
      "Customized funding strategies aligned with your business goals",
      "Identification of optimal funding sources (equity, debt, grants, NBFCs)",
      "Compelling investment narratives and robust financial projections",
    ],
  },
  {
    title: "Bank Loan & Debt Management",
    points: [
      "End-to-end loan origination and application support",
      "Pre-qualification and eligibility assessment",
      "Loan counselling, debt consolidation, and restructuring",
      "Credit risk assessment and credit repair guidance",
    ],
  },
  {
    title: "Credit Enhancement & More",
    points: [
      "Preparation of investor-ready documents and pitch materials",
      "Negotiation support with banks, financial institutions, and lenders",
    ],
  },
];
...
const whoFor = [
  ...
  "Established businesses looking for working capital or project finance",
  "Entrepreneurs planning IPO or large-scale funding",
];

const benefits = [
  "Faster loan approvals and better terms",
  "Reduced rejection risk through professional documentation",
  "Access to the right mix of funding without unnecessary dilution",
  "Ongoing support even after funds are secured",
];

const process = [
  "Free Initial Consultation & Needs Assessment",
  "Financial Health Review & Strategy Development",
  "Documentation Preparation & Application Submission",
  "Lender Negotiation & Closure",
  "Post-Funding Support & Monitoring",
];

export default function FundingAdvisoryPage() {
  return (
    <main className="sp-page">
      ...
      <section className="sp-hero">
        ...
        <div className="sp-container">
          <div className="sp-breadcrumb">
            ...
            <span>Funding Advisory</span>
          </div>
          <p className="sp-eyebrow">Funding Advisory</p>
          <h1 className="sp-hero-title">
            Secure the Right Capital —{" "}
            <span className="sp-gold">Faster, Smarter & with Confidence</span>
          </h1>
          <p className="sp-hero-desc">
            Expert funding strategies, bank loan support, debt management, and credit enhancement tailored for Indian startups and growing businesses. We turn your growth vision into funded reality.
          </p>
      ...
      <section className="sp-section sp-white">
        <div className="sp-container">
          ...
          <p className="sp-section-desc">
            We combine deep financial expertise with a client-centric approach to make fundraising efficient and effective.
          </p>
      ...
      <section className="sp-section sp-white">
        <div className="sp-container">
          ...
          <h2 className="sp-section-title">How We Help You Succeed</h2>
      ...
      <section className="sp-section sp-gray" id="process">
        <div className="sp-container">
          ...
          <h2 className="sp-section-title">Our Proven Process</h2>
        ...
        <div className="sp-container">
          <div className="sp-cta-box">
            ...
            <div className="sp-cta-content">
              <h2 className="sp-cta-title">Ready to Secure Your Funding?</h2>
              <p className="sp-cta-desc">
                Don't let capital constraints hold your business back. Book a free 30-minute consultation today and take the first step toward successful fundraising.
              </p>
